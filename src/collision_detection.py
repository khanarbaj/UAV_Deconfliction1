...
class HandleCollission:
    ...
    def detect_collision(primary_uav_info: UAV_Info):
        ...
        if HandleCollission.FinalCollisionResult == False:
            print("clear")
        return Is_collision,HandleCollission.detectedDistance,HandleCollission.collision_Info
    ...
    def PrintCollissionInfo(index):
        ...
        print(f"Detected Distance (x_distance,y_distance,z_distance): \
                ({HandleCollission.detectedDistance[index].x_distance} cm, \
                {HandleCollission.detectedDistance[index].y_distance} cm, \
                {HandleCollission.detectedDistance[index].z_distance} cm)")
